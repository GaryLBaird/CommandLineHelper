...
"GitCommit"     Pulls latest code and prompts for commit message before committing changes.
"HGCommit"      Pulls latest code and prompts for commit message before committing changes.
...
"sshi"           Easiest way to connect to a linux machine. 
 ...
 "simpleDownload" Downloads file from internet.
 "iexplore="      Starts Internet Explorer
 "ie"            Starts Internet Explorer
 "firefox"       Starts Firefox 
 "KILL"         Kills a task by name.
 "clh-install"  Shortcut for CommandLineHelper from source dir without prompts.  "setup.bat --Install Y"
```
